...
Node.js 24 automatically. Native installs use a systemd service to start the
dashboard after reboot (a user service for regular users and a system service
for root installs). See [deployment and operations](docs/DEPLOYMENT.md)
